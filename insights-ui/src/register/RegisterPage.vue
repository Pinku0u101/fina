    ...
    <div class="sngc">
        ...
        <form @submit.prevent="handleSubmit">
           ...
           <div class="form-group">
            ...
            <input type="number" v-model="user.age" v-validate="'required'" id="age" name="age" class="form-control" :class="{ 'is-invalid': submitted && errors.has('age') }" />
            ...
            <input type="number" v-model="user.phoneNumber" v-validate="'required: true, min: 9'" name="phoneNumber" class="form-control" :class="{ 'is-invalid': submitted && errors.has('phoneNumber') }" />
            <div v-if="submitted && errors.has('phoneNumber')" class="invalid-feedback">{{ errors.first('phoneNumber') }}</div>
            </div>

            <div class="form-group">
                <label for="occupation" class="labelClass">Occupation</label>
                <input type="text" v-model="user.occupation" v-validate="'required'" name="occupation" class="form-control" :class="{ 'is-invalid': submitted && errors.has('occupation') }" />
                <div v-if="submitted && errors.has('occupation')" class="invalid-feedback">{{ errors.first('occupation') }}</div>
            </div>

            <div class="form-group">
                <label for="college" class="labelClass">College</label>
                <input type="text" v-model="user.college" v-validate="'required'" name="college" class="form-control" :class="{ 'is-invalid': submitted && errors.has('college') }" />
                <div v-if="submitted && errors.has('college')" class="invalid-feedback">{{ errors.first('college') }}</div>
            </div>

            <div class="form-group">
                <label for="country" class="labelClass">Country</label>
                <select v-model="user.country" v-validate="'required'" name="country" class="form-control" :class="{ 'is-invalid': submitted && errors.has('country') }">
